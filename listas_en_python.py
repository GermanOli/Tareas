...
Original file is located at
    https://colab.research.google.com/drive/1OsfL6Oz8QRhBLQDG7QQF_JMbzRMTLXKb
...
l.sort(reverse=True)
may= l[0]
l.extend([["El promedio es =", promedio ], ["La edad mayor es =", may], ["La edad menor es =", men]])
for i in range(0,9):
  print("edad", l[i])
...
for i in range(14):
  ...
  if sueldo > 2500.00:
    ...
    print("El sueldo de un empleado es mayor de $2500.00")
    break
...
"""##Carlos German Miramontes Olivares"""